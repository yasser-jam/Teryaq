      ...
      >
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              'flex w-full px-3 rounded-md border h-11 items-center justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto',
              className
            )}
          >
            {selectedValues.length > 0 ? (
              <div className="flex justify-between items-center w-full overflow-hidden">
                ...
                <div className="relative flex items-center justify-between">
                  ...
                  />
                  {loading ? (
                    <Restart className="animate-spin h-4 mx-2 cursor-pointer text-text-secondary" />
                  ) : (
        ...
        <PopoverContent
          className={cn('w-auto p-0', contentClass)}
          align="start"
